// FIFO demo for accelerometer & gyro readings from Adafruit LSM6DSOX
// using SPI interface.
//
// The FIFO buffers sensor data so you can read in batches instead of polling.
// This is useful for reducing bus traffic and ensuring no samples are missed.
// SPI is faster than I2C which is ideal for high-throughput FIFO reads.
...
void setup(void) {
  ...
  Serial.println("Adafruit LSM6DSOX FIFO test (SPI)!");
